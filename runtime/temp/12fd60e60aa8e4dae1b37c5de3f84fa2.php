<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/alidata/www/shemblog/public/../application/index/view/cate_index.html";i:1489992446;s:66:"/alidata/www/shemblog/public/../application/index/view/layout.html";i:1490596000;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<ol class="breadcrumb sider-margin">
    ...
    <li class="active">分类&nbsp;|&nbsp;<?php echo $title; ?></li>
</ol>


        <div class="col-md-8 row-left index">
            
<?php if(is_array($catedata['articles']) || $catedata['articles'] instanceof \think\Collection): $i = 0; $__LIST__ = $catedata['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Cateart): $mod = ($i % 2 );++$i;?>
    <article>
        <h5>
            <?php if($Cateart['art_original'] == '1'): ?>
            <span class="original">[ 原创 ]</span>
            <i class="iconfont icon-recommend tui"></i>
            <?php else: ?>
            <span class="reprint">[ 转载 ]</span>
            <?php endif; ?>
            <a href="<?php echo url('Article/index',['id'=>$Cateart['art_id']]); ?>"><?php echo $Cateart['art_title']; ?></a>
        </h5>
        <div class="clearfix" >
            <p class="article-remark">
                <a class="article-img-a image-light" href="<?php echo url('Article/index',['id'=>$Cateart['art_id']]); ?>">
                    <img src="<?php echo $Cateart['art_img']; ?>" class="article-img" alt="<?php echo $Cateart['art_title']; ?>" title="<?php echo $Cateart['art_title']; ?>" />
                </a>
                <?php echo $Cateart['art_remark']; ?>
                <a href="<?php echo url('Article/index',['id'=>$Cateart['art_id']]); ?>" class="article-look">继续阅读</a>
            </p>
            <footer class="article-footer">
                <div class="article-footer-l">
                    <i class="iconfont icon-tags"></i><?php echo getKeyword($Cateart['art_keyword']); ?>
                </div>
                <div class="article-footer-r">
                    <i class="iconfont icon-hit"></i>&nbsp;<?php echo $Cateart['art_hit']; ?>&nbsp;&nbsp;
                    <i class="iconfont icon-review"></i>&nbsp;<?php echo getNums($Cateart['nums']); ?>
                </div>
            </footer>
        </div>
    </article>
<?php endforeach; endif; else: echo "" ;endif; if(count($catedata['articles']) >= 8): ?>
<div class="more">
    <span class="loadingmore" data-id="<?php echo \think\Request::instance()->param('id'); ?>" data-key="<?php echo \think\Request::instance()->param('key'); ?>" data-lenth="1" data-url="<?php echo url('Cate/ajaxList'); ?>">加载更多</span>
</div>
<?php endif; ?>
