<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/alidata/www/shemblog/public/../application/index/view/links_index.html";i:1490086554;s:66:"/alidata/www/shemblog/public/../application/index/view/layout.html";i:1490596000;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="links-head-ban">
    <div class="links-head">
        ...
        <h5><?php echo \think\Config::get('auth.blogname'); ?>朋友圈</h5>
        <p>为避免版权纠纷，本站只接受网站完善并且原创更新比较稳定相关的工作室、站点、博客、论坛……</p>
        <p>申请链接请直接在留言板留言，或发送邮件至admin@loveteemo.com</p>
    </div>
</div>
...
<div class="container">
    <div class="row aerousel">
        <div class="links">
            <div class="links-two">
                <?php if(is_array($linkdata) || $linkdata instanceof \think\Collection): $i = 0; $__LIST__ = $linkdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lt): $mod = ($i % 2 );++$i;?>
                <div class="links-two-item">
                    <div class="links-two-inner links-two-3d">
                        <a href="<?php echo $lt['link_url']; ?>" target="_blank" title="<?php echo $lt['link_name']; ?>">
                            <h3 class="links-h3"><img src="<?php echo $lt['link_favicon']; ?>" width="24" alt="<?php echo $lt['link_name']; ?>">
                                <span><?php echo $lt['link_name']; ?></span>
                            </h3>
                        <p class="links-p" style="margin-top: 10px"><?php echo $lt['link_content']; ?></p>
                        </a>
                    </div>
                    <div class="links-two-bg links-two-3d">
                        <a href="<?php echo $lt['link_url']; ?>" target="_blank" title="<?php echo $lt['link_name']; ?>">
                            <div>
                            <img src="<?php echo $lt['link_favicon']; ?>" width="48" alt="<?php echo $lt['link_name']; ?>">
                            <h3 class="links-h3"><?php echo $lt['link_name']; ?></h3>
                            <p class="links-p"><?php echo $lt['link_url']; ?></p>
                            </div>
                        </a>
                    </div>
                </div>
